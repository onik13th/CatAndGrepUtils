...
//   const char *sample_one[] = {"^@", "^A", "^B", "^C", "^D",
//                               "^E", "^F", "^G", "^H"};
//   const char *sample_two[] = {"^K", "^L", "^M", "^N",  "^O", "^P", "^Q",
//                               "^R", "^S", "^T", "^U",  "^V", "^W", "^X",
//                               "^Y", "^Z", "^[", "^\\", "^]", "^^", "^_"};
//   const char *sample_three[] = {
...
//   memcpy(table, sample_one, sizeof sample_one);
//   memcpy(&table[9 + 2], sample_two, sizeof sample_two);
//   memcpy(&table['~' + 1], sample_three, sizeof sample_three);
// }
...
void cat_set_non_printble(const char *table[static 256]) {
  ...
  const char *sample3[] = {
      ...
      "M-^G", "M-^H", "M-^I", "M-^J",  "M-^K", "M-^L", "M-^M", "M-^N",
      "M-^O", "M-^P", "M-^Q", "M-^R", "M-^S",  "M-^T", "M-^U", "M-^V",
      "M-^W", "M-^X", "M-^Y", "M-^Z", "M-^[", "M-^\\", "M-^]", "M-^^",
      "M-^_", "M- ",  "M-^!", "M-\"", "M-#",  "M-$",  "M-%",   "M-&",  "M-'",
      "M-(",  "M-)",  "M-*",  "M-+", "M-,",  "M--",  "M-.",   "M-/",  "M-0",
      "M-1",  "M-2",  "M-3",  "M-4", "M-5",  "M-6",  "M-7",   "M-8",  "M-9",
      "M-:",  "M-;",  "M-<",  "M-=", "M->",  "M-?",  "M-@",   "M-A",  "M-B",
      "M-C",  "M-D",  "M-E",  "M-F", "M-G",  "M-H",  "M-I",   "M-J",  "M-K",
      "M-L",  "M-M",  "M-N",  "M-O", "M-P",  "M-Q",  "M-R",   "M-S",  "M-T",
      "M-U",  "M-V",  "M-W",  "M-X", "M-Y",  "M-Z",  "M-[",   "M-\\", "M-]",
      "M-^",  "M-_",  "M-`",  "M-a", "M-b",  "M-c",  "M-d",   "M-e",  "M-f",
